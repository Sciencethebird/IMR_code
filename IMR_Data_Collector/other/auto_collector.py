...
import numpy as np
import random
from ros_camera_controller import ROSCamera
import numpy as np
...
class image_converter:
  ...
  def callback(self,data):
    ...
    randx = random.uniform(1.5, 1.9)
    randy = random.uniform(1.5, 1.9)
    randz = random.uniform(1.0, 1.5)
    self.cam.move_to(randx, randy, randz)
    self.cam.point_camera_at(0.3, 0, 1.0, 1.0)
